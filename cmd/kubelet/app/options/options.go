...
func AddKubeletConfigFlags(mainfs *pflag.FlagSet, c *kubeletconfig.KubeletConfiguration) {
	...
	fs.StringVar(&c.CPUManagerBestEffortCPUs, "be-cpuset", c.CPUManagerBestEffortCPUs, "CPU Manager cpuset for Best Effort QoS class. Uses CPUSet notation.")
	fs.StringVar(&c.CPUManagerOtherCPUs, "other-cpuset", c.CPUManagerOtherCPUs, "CPU Manager cpuset for Burstable and Guaranteed QoS classes. Uses CPUSet notation.")
